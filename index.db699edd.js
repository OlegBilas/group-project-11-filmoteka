 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ao{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){const t=new uo;if(this.instancesDeferred.set(e,t),this.isInitialized(e)||this.shouldAutoInitialize())try{const n=this.getOrInitializeService({instanceIdentifier:e});n&&t.resolve(n)}catch(t){}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;const n=this.normalizeInstanceIdentifier(null==t?void 0:t.identifier),i=null!==(e=null==t?void 0:t.optional)&&void 0!==e&&e;if(!this.isInitialized(n)&&!this.shouldAutoInitialize()){if(i)return null;throw Error(`Service ${this.name} is not available`)}try{return this.getOrInitializeService({instanceIdentifier:n})}catch(t){if(i)return null;throw t}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,this.shouldAutoInitialize()){if(function(t){return"EAGER"===t.instantiationMode}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
xs("firebase","9.19.1","app");const As=bs({apiKey:"AIzaSyDFBT4l6qIJNa5FHkQwrhjL1oZ0g4xnyss",authDomain:"group-project-11-filmoteka.firebaseapp.com",projectId:"group-project-11-filmoteka",databaseURL:"https://group-project-11-filmoteka-default-rtdb.firebaseio.com",storageBucket:"group-project-11-filmoteka.appspot.com",messagingSenderId:"114137226490",appId:"1:114137226490:web:4cfd8cb3a42074d592bd43"});
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class ra{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class oa{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable((()=>e(Ls.UNAUTHENTICATED)))}shutdown(){}}class sa{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable((()=>e(this.token.user)))}shutdown(){this.changeListener=null}}class aa{constructor(t){this.auth=null,t.onInit((t=>{this.auth=t}))}getToken(){return this.auth?this.auth.getToken().then((t=>t?(zs("string"==typeof t.accessToken),new ra(t.accessToken,new Ls(this.auth.getUid()))):null)):Promise.resolve(null)}invalidateToken(){}start(t,e){}shutdown(){}}class la{constructor(t,e,n){this.t=t,this.i=e,this.o=n,this.type="FirstParty",this.user=Ls.FIRST_PARTY,this.u=new Map}h(){return this.o?this.o():null}get headers(){this.u.set("X-Goog-AuthUser",this.t);const t=this.h();return t&&this.u.set("Authorization",t),this.i&&this.u.set("X-Goog-Iam-Authorization-Token",this.i),this.u}}class ca{constructor(t,e,n){this.t=t,this.i=e,this.o=n}getToken(){return Promise.resolve(new la(this.t,this.i,this.o))}start(t,e){t.enqueueRetryable((()=>e(Ls.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class ua{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class fa{constructor(t){this.l=t,this.appCheck=null,t.onInit((t=>{this.appCheck=t}))}getToken(){return this.appCheck?this.appCheck.getToken().then((t=>t?(zs("string"==typeof t.token),new ua(t.token)):null)):Promise.resolve(null)}invalidateToken(){}start(t,e){}shutdown(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class La{static N(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length;let n="";for(;n.length<20;){const i=Aa(40);for(let r=0;r<i.length;++r)n.length<20&&i[r]<e&&(n+=t.charAt(i[r]%t.length))}return n}}function Pa(t,e){return t<e?-1:t>e?1:0}function Da(t,e,n){return t.length===e.length&&t.every(((t,i)=>n(t,e[i])))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ol{constructor(t,e=null,n=[],i=[],r=null,o="F",s=null,a=null){this.path=t,this.collectionGroup=e,this.explicitOrderBy=n,this.filters=i,this.limit=r,this.limitType=o,this.startAt=s,this.endAt=a,this.O=null,this.k=null,this.startAt,this.endAt}}function Cl(t){return t.explicitOrderBy.length>0?t.explicitOrderBy[0].field:null}function Rl(t){for(const e of t.filters){const t=e.getFirstInequalityField();if(null!==t)return t}return null}function Al(t){const e=Vs(t);if(null===e.O){e.O=[];const t=Rl(e),n=Cl(e);if(null!==t&&null===n)t.isKeyField()||e.O.push(new yl(t)),e.O.push(new yl(ya.keyField(),"asc"));else{let t=!1;for(const n of e.explicitOrderBy)e.O.push(n),n.field.isKeyField()&&(t=!0);if(!t){const t=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc";e.O.push(new yl(ya.keyField(),t))}}}return e.O}function Ll(t){const e=Vs(t);if(!e.k)if("F"===e.limitType)e.k=Tl(e.path,e.collectionGroup,Al(e),e.filters,e.limit,e.startAt,e.endAt);else{const t=[];for(const n of Al(e)){const e="desc"===n.dir?"asc":"desc";t.push(new yl(n.field,e))}const n=e.endAt?new ol(e.endAt.position,e.endAt.inclusive):null,i=e.startAt?new ol(e.startAt.position,e.startAt.inclusive):null;e.k=Tl(e.path,e.collectionGroup,t,e.filters,e.limit,n,i)}return e.k}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nf(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Rf(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Tf(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Lf(e))return"Blackberry";if(Pf(e))return"Webos";if(Of(e))return"Safari";if((e.includes("chrome/")||Cf(e))&&!e.includes("edge/"))return"Chrome";if(Af(e))return"Android";{const e=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=t.match(e);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Tf(t=ho()){return/firefox\//i.test(t)}function Of(t=ho()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Cf(t=ho()){return/crios\//i.test(t)}function Rf(t=ho()){return/iemobile/i.test(t)}function Af(t=ho()){return/android/i.test(t)}function Lf(t=ho()){return/blackberry/i.test(t)}function Pf(t=ho()){return/webos/i.test(t)}function Df(t=ho()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function Bf(){return mo()&&10===document.documentMode}function Mf(t=ho()){return Df(t)||Af(t)||Pf(t)||Lf(t)||/windows phone/i.test(t)||Rf(t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */await(n=Ah,i=t,r=e,md(Oo(n),td.credential(i,r))).then((t=>{const e=t.user;localStorage.setItem("fireBaseAuthorized",Ah.currentUser.uid),gu("uk"===dr?`Ви ввійшли з електронної пошти ${e.email}`:`You have been logged in with e-mail ${e.email}`),Rh.authForm.reset(),Dh(),Bh()})).catch((t=>{yu("uk"===dr?`Ваш вхід невдалий. Причина: ${t.message}`:`Your log in has been failed. Reason: ${t.message}`)}))},Dh=()=>{const t=Rh.authBtn.innerHTML;Rh.authBtn.textContent.includes("Log in")?Rh.authBtn.innerHTML=t.replace("Log in","Log out"):Rh.authBtn.textContent.includes("Log out")?Rh.authBtn.innerHTML=t.replace("Log out","Log in"):Rh.authBtn.textContent.includes("Вхід")?Rh.authBtn.innerHTML=t.replace("Вхід","Вихід"):Rh.authBtn.textContent.includes("Вихід")&&(Rh.authBtn.innerHTML=t.replace("Вихід","Вхід"))},Bh=()=>{Rh.authBox.classList.remove("active")},Mh=()=>{Rh.logInBtn.classList.add("active"),Rh.signUpBtn.classList.remove("active"),Rh.formTitle.textContent="uk"===dr?"Вхід":"Log in",Rh.inputEmail.placeholder="uk"===dr?"електронна пошта":"e-mail",Rh.inputPassword.placeholder="uk"===dr?"пароль":"password"},jh=()=>{Rh.mobileMenuContainer.classList.remove("active"),Rh.navBox.classList.remove("active")};var Fh,Uh,zh;Rh.mobileMenuCloseBtn.addEventListener("click",jh),Rh.mobileMenuOpenBtn.addEventListener("click",(()=>{Rh.mobileMenuContainer.classList.add("active"),Rh.navBox.classList.add("active")})),Rh.authForm.addEventListener("submit",(t=>{t.preventDefault();const{elements:{email:n,password:i}}=t.currentTarget;""!==n.value||""!==i.value?(Rh.signUpBtn.classList.contains("active")?Lh():Ph(),Cr(document.body)):e(pu).Notify.failure("uk"===dr?"Будь ласка, заповніть всі поля":"Please fill all fields",mu)})),Rh.authBtn.addEventListener("click",(()=>{var t;(Rh.authBtn.textContent.includes("Log in")||Rh.authBtn.textContent.includes("Вхід"))&&(Rh.authBox.classList.add("active"),Mh()),localStorage.getItem("fireBaseAuthorized")&&(t=Ah,Oo(t).signOut()).then((()=>{var t;localStorage.removeItem("fireBaseAuthorized"),Dh(),t="uk"===dr?"Ви вийшли з акаунту":"You have been logged out",e(pu).Notify.info(t,mu),Cr(document.body)})).catch((t=>console.log(t)))})),Rh.closeBtn.addEventListener("click",Bh),Rh.signUpBtn.addEventListener("click",(()=>{Rh.logInBtn.classList.remove("active"),Rh.signUpBtn.classList.add("active"),Rh.formTitle.textContent="uk"===dr?"Реєстрація":"Sign up",Rh.inputEmail.placeholder="uk"===dr?"Введіть Вашу електронну пошту":"Enter your e-mail",Rh.inputPassword.placeholder="uk"===dr?"Введіть пароль":"Enter password"})),Rh.logInBtn.addEventListener("click",Mh),Rh.lockBtn.addEventListener("click",(()=>{"password"===Rh.inputPassword.type?(Rh.inputPassword.type="text",Rh.lockSvg.href.baseVal="/icons.adfc4680.svg#icon-unlocked"):(Rh.inputPassword.type="password",Rh.lockSvg.href.baseVal="/icons.adfc4680.svg#icon-lock")})),Fh=()=>{const t=localStorage.getItem("fireBaseAuthorized");t&&t===Ah.currentUser?.uid||qh()},Oo(Ah).onAuthStateChanged(Fh,Uh,zh);const Vh={headerhForm:document.querySelector(".header-form"),searchForm:document.querySelector(".search-form"),nav:document.querySelector(".header-nav"),homeBtn:document.querySelector(".home-btn"),myLibraryBtn:document.querySelector(".my-library-btn"),watchedBtn:document.querySelector(".watched-btn"),queueBtn:document.querySelector(".queue-btn"),logo:document.querySelector(".logo-wrapper"),logoRef:document.querySelector(".logo"),galleryList:document.querySelector(".list")};let Wh="",$h=0;function qh(){vu("start"),Vh.watchedBtn.classList.add("is-hidden"),Vh.queueBtn.classList.add("is-hidden"),Vh.headerhForm.classList.remove("js-form-inactive"),Vh.nav.classList.remove("js-home-inactive"),Vh.logo.classList.remove("js-library-active"),Vh.homeBtn.classList.add("active-btn"),jh(),Lu(),Vh.myLibraryBtn.classList.contains("active-btn")&&Vh.myLibraryBtn.classList.remove("active-btn"),hr("").then((t=>{wu(t),Iu(t.total_pages,"")})),Eu.classList.remove("hidden"),vu("stop"),Jh(),Cr(document.body)}function Hh(){Vh.watchedBtn.classList.remove("is-hidden"),Vh.queueBtn.classList.remove("is-hidden"),Vh.headerhForm.classList.add("js-form-inactive"),Vh.nav.classList.add("js-home-inactive"),Vh.logo.classList.add("js-library-active"),Nu(),Vh.homeBtn.classList.remove("active-btn"),Vh.myLibraryBtn.classList.add("active-btn"),jh(),Xh(),Jh(),Cr(document.body)}function Kh(){Lu(),Vh.galleryList.innerHTML="",Nu(),Ru(Dr),Vh.watchedBtn.classList.add("active-library-btn"),Vh.queueBtn.classList.remove("active-library-btn")}function Xh(){Lu(),Vh.galleryList.innerHTML="",Nu(),Ru(Pr),Vh.watchedBtn.classList.remove("active-library-btn"),Vh.queueBtn.classList.add("active-library-btn")}Vh.searchForm.addEventListener("submit",(async function(t){if(t.preventDefault(),vu("start"),Wh=t.currentTarget.searchQuery.value.trim(),!Wh)return vu("stop"),void e(pu).Notify.failure("uk"===dr?"Введіть Ваш пошуковий запит, будь ласка.":"Enter your search query, please.",mu);t.currentTarget.reset();const n=await hr(Wh);$h=n.results.length;try{$h>0&&(vu("stop"),e(pu).Notify.success("uk"===dr?"Ми знайшли те, що Ви шукали!":"We`ve found what you were looking for!",mu),wu(n),Iu(n.total_pages,Wh),1===n.total_pages&&(Ru(),Nu())),0===$h&&(vu("stop"),e(pu).Notify.failure("uk"===dr?"Результат пошуку невдалий. Введіть коректну назву фільму.":"Search result is not successful. Enter the correct movie name.",mu),wu(n),Iu(n.total_pages,Wh))}catch(t){vu("stop"),console.log(t)}})),Vh.homeBtn.addEventListener("click",qh),Vh.logoRef.addEventListener("click",qh),Vh.myLibraryBtn.addEventListener("click",Hh),Vh.watchedBtn.addEventListener("click",Kh),Vh.queueBtn.addEventListener("click",Xh);const Jh=()=>{const t={status:"active",id:document.querySelector(".active-btn").id};localStorage.setItem("button",JSON.stringify(t))},Gh=20;localStorage.getItem("fireBaseAuthorized")&&Dh(),(()=>{const t=JSON.parse(localStorage.getItem("button"));t?"1"===t.id?qh():"2"===t.id&&Hh():qh()})()}();
//# sourceMappingURL=index.db699edd.js.map
